...
app.controller('spCtrl', function ($scope, $timeout, $filter, $cookies) {
 ...
 /*     { codigo: '41', descricao: 'Aposentadoria por Idade Rural' },
    ...
    $scope.itensMotivoDespacho = {
        ...
        txtTipoAvaliacaoIncapacidade: "Perícia"
    };
    ...
    $scope.montarMotivo = function () {
        ...
        switch ($scope.tipoDespacho) {
            case 'Indeferimento':
                if ($scope.especieSelecionada.descricao == 'Certidão de Tempo de Contribuição') {
                    ...
                    conclusaoDespacho = "Sem mais diligências. Arquive-se."; /* conclusaoDespacho = "Certidão indeferida, e a tarefa correspondente encerrada nesta data."; */
                } else {
                    tipoDespacho = " Indeferido";
                    conclusaoDespacho = "Sem mais diligências. Arquive-se."; /* conclusaoDespacho = "Benefício indeferido, e a tarefa correspondente encerrada nesta data."; */
                };
            ...
            case 'Concessão':
                if ($scope.especieSelecionada.descricao == 'Certidão de Tempo de Contribuição') {
                    ...
                    conclusaoDespacho = "Sem mais diligências. Arquive-se."; /* conclusaoDespacho = "Certidão concedida, e a tarefa correspondente encerrada nesta data."; */
                } else {
                    tipoDespacho = " Concedido";
                    conclusaoDespacho = "Sem mais diligências. Arquive-se."; /* conclusaoDespacho = "Benefício concedido, e a tarefa correspondente encerrada nesta data."; */
                };
                switch ($scope.especieSelecionada.descricao) {
                    case 'Pensão por Morte Urbana':
        ...
        if ($scope.especieSelecionada.descricao == 'Certidão de Tempo de Contribuição' || $scope.especieSelecionada.descricao == 'Benefício Assistencial ao Deficiente' ||
            $scope.especieSelecionada.descricao == 'Benefício Assistencial ao Idoso' || $scope.especieSelecionada.descricao == 'Benefício por Incapacidade Temporária Urbano' || $scope.especieSelecionada.descricao == 'Benefício por Incapacidade Temporária Rural') {
    ...
    $scope.montarVinculo = function () {
        ...
        switch ($scope.itensVinculo.txtVinculoConsiderado) {
            case 'Não há':
                ...
                break;
            case 'Apenas_CNIS':
                conclusaoVinculo = "Apenas os vínculos e recolhimentos contemporâneos constantes no CNIS foram utilizados no cálculo do tempo de contribuição, conforme disposto no caput do artigo 19 do Decreto nº 3.048/99.";
                break;
            case 'CNIS':
                ...
                break;
            case 'CNIS_CTPS':
                conclusaoVinculo = "Foram considerados todos os vínculos regulares constantes na(s) Carteira(s) de Trabalho e Previdência Social, bem como no Cadastro Nacional de Informações Sociais (CNIS), conforme disposto no §1º e caput do art. 19 e no §1º do art. 19-B, ambos do Decreto nº 3.048/99.";
            break;
            case 'Documento e CNIS':
                let listaDocumentos = [];

                if ($scope.itensVinculo.chkDocCTPS) {
                    listaDocumentos.push("Carteira(s) de Trabalho e Previdência Social");
                };
                ...
                if ($scope.itensVinculo.chkDocDTC) {
                    listaDocumentos.push("Declaração de Tempo de Contribuição - DTC nº " + $scope.itensVinculo.txtDocDTC);
                };
            ...
            case 'Documento Parcial e CNIS':
                ...
                if ($scope.especieSelecionada.descricao == 'Certidão de Tempo de Contribuição' && $scope.itensVinculo.chkConcomitanciaDebito) {
                    listaMotivos.push("da concomitância com período(s) de débito, não sendo devida a certificação do período abrangido em nenhuma das atividades, nos termos do inciso VII, art. 513 da Instrução Normativa nº 128/2022, e §2º, art. 554 da Portaria Dirben/INSS nº 991/2022 (Livro II - Benefício)");
                };
        ...
        switch ($scope.itensContribuicao.txtFacultativoConsiderado) {
            ...
            case 'Parcial':
                ...
                if ($scope.itensContribuicao.chkFacConcomitante) {
                    listaMotivos.push(" o recolhimento das competências " + $scope.itensContribuicao.txtFacConcomitante + " é concomitante com atividade de filiação obrigatória ou benefício previdenciário, em desacordo com o disposto no §5º do art. 107 da Instrução Normativa nº 128/2022, e §5º do art. 74 da Portaria Dirben/INSS nº 990/2022 (Livro I - Cadastro)");
                };
        ...
        switch ($scope.itensEspecial.txtEspecialConsiderado) {
            ...
            case 'Reconhecida':
                ...
                if ($scope.itensEspecial.chkEnqAgenteNocivo) {
                    listaMotivos.push("por exposição a agentes prejudiciais à saúde, conforme parecer da Perícia Médica");
                };
                if ($scope.itensEspecial.chkEnqNbAnterior) {
                    listaMotivos.push("pelo aproveitamento de períodos analisados em requerimento anterior, importados para o presente benefício e com reanálise dispensada, nos termos do art. 270 da Instrução Normativa nº 128/2022");
                };
                ...
                if (($scope.especieSelecionada.descricao == 'Certidão de Tempo de Contribuição') && ($scope.itensEspecial.chkEnqCatProfissional || $scope.itensEspecial.chkEnqAgenteNocivo || $scope.itensEspecial.chkEnqNbAnterior)) {
                    conclusaoEspecial += " Registre-se no presente requerimento que os períodos reconhecidos como de atividade exercida em condições especiais foram incluídos na CTC e discriminados de data a data, sem a conversão em tempo comum, conforme disciplinado no art. 515 da Instrução Normativa nº 128/2022 e art. 555 da Portaria Dirben/INSS nº 991/2022 (Livro II - Benefício), e em observância à vedação contida no inc. I, art. 96 da Lei nº 8.213/91.";
                };
                break;
            case 'Reconhecida Parcial':
                ...
                if ($scope.itensEspecial.chkNaoEnqCatProfissional) {
                    listaMotivos.push("das atividades descritas não estarem relacionadas nos anexos enumerados no Anexo XVI (Enquadramento de Atividade Especial), não sendo passíveis de enquadramento por Categoria Profissional até 28/04/1995, nos termos do §1º do art. 269 da Instrução Normativa nº 128/2022");
                };
                if ($scope.itensEspecial.chkNaoEnqAgenteNocivo) {
                    listaMotivos.push("da não comprovação de exposição a agentes prejudiciais à saúde, conforme parecer da Perícia Médica, nos termos do caput e § 1º do art. 287 da Instrução Normativa nº 128/2022");
                };
                if ($scope.itensEspecial.chkNaoEnqAgenteNocivoAusente) {
                    listaMotivos.push("de não terem sido submetidos à análise da Perícia Médica, por conta da ausência de informação de exposição a agentes prejudiciais à saúde nos documentos apresentados, nos termos do art. 287 da Instrução Normativa nº 128/2022");
                };
                if ($scope.itensEspecial.chkNaoEnqNbAnterior) {
                    listaMotivos.push("do aproveitamento de períodos analisados em requerimento anterior, importados para o presente benefício e com reanálise dispensada, nos termos do art. 270 da Instrução Normativa nº 128/2022");
                };
        ...
        switch ($scope.itensRural.txtRuralConsiderado) {
            ...
            case 'Reconhecida Parcial':
                ...
                if ($scope.itensRural.chkAtividadeRemunerada) {
                    listaMotivos.push("do exercício intercalado de Atividade Remunerada / Urbana, sem a apresentação de prova de retorno do(a) Requerente ao exercício de atividade rural, nos termos do inc. V do §2º, art. 116 da Instrução Normativa nº 128/2022");
                };
                ...
                if ($scope.itensRural.chkRecebeuBPC) {
                    if ($scope.itensRural.txtPeriodoBPC != "") {
                        listaMotivos.push("da descaracterização da condição de Segurado Especial, em função do recebimento de Benefício de Prestação Continuada - BPC no período de " + $scope.itensRural.txtPeriodoBPC + ", nos termos do §3º, art. 112 da Instrução Normativa nº 128/2022");
                    } else {
                        listaMotivos.push("da descaracterização da condição de Segurado Especial, em função do recebimento de Benefício de Prestação Continuada - BPC, nos termos do §3º, art. 112 da Instrução Normativa nº 128/2022");
                    };
                };
                if ($scope.itensRural.chkNaoIndenizado) {
                    if ($scope.especieSelecionada.descricao == 'Aposentadoria por Tempo de Contribuição') {
                        listaMotivos.push("da não indenização de período comprovado a partir de Novembro/1991, nos termos do §2º, art. 55 da Lei nº 8.213/91, e inciso II, art. 215 da Instrução Normativa nº 128/2022");
                    } else if ($scope.especieSelecionada.descricao == 'Certidão de Tempo de Contribuição') {
                        listaMotivos.push("da não indenização de período comprovado, nos termos do inciso IV, art. 96 da Lei nº 8.213/91, e dos incisos III e IV, art. 514 da Instrução Normativa nº 128/2022");
                    };
                };
            ...
            case 'Não reconhecida':
                ...
                if ($scope.itensRural.chkSemAutodeclaracao) {
                    listaMotivos.push("de não ter sido apresentada Autodeclaração do Segurado Especial, devidamente preenchida e assinada, nos moldes dos Anexos VIII/IX/X da Instrução Normativa nº 128/2022");
                };
                if ($scope.itensRural.chkNaoCompoeGrupoFamiliar) {
                    listaMotivos.push("dos documentos apresentados como Prova Material estarem em nome de terceiro que não compõe o grupo familiar, considerando o grau de parentesco entre o Titular dos documentos e o(a) Requerente, ou em razão do Casamento deste(a) último(a), nos termos dos incisos I e IV, §1º, art. 109 da Instrução Normativa nº 128/2022");
                };
    ...
    $scope.montarExigencia = function () {
        ...
        switch ($scope.itensExigencia.txtExigenciaConsiderado) {
            case 'Não há':
                ...
                break;
            case 'Cumprida':
                conclusaoExigencia = "Foram formuladas exigências ao(à) Requerente, que foram integralmente cumpridas, e suficientes para a imediata decisão do requerimento e verificação do direito pleiteado, nos termos do §3º, art. 566 da Instrução Normativa nº 128/2022.";
                break;
            ...
            case 'Não cumprida':
                ...
                if ($scope.itensExigencia.txtExigenciaNaoCumprida == "Não apresentou") {
                    if ($scope.especieSelecionada.descricao == 'Benefício Assistencial ao Deficiente' || $scope.especieSelecionada.descricao == 'Benefício Assistencial ao Idoso') {
                        conclusaoExigencia += " Passados mais de 30 dias da sua comunicação, não foram cumpridos todos os requisitos regulamentares que permitem a sua concessão, nos termos do art. 37 da Lei nº 8.742/93, e art. 20 do Decreto nº 6.214/07.";
                    }
                    else {
                        conclusaoExigencia += " Passados mais de 30 dias da sua comunicação, não houve a apresentação de quaisquer documentos, ou qualquer manifestação a respeito por parte do(a) Requerente, o que resulta no arquivamento do pedido, nos termos do art. 40 da Lei nº 9.784/99, e §4º, art. 574 da Instrução Normativa nº 128/2022.";
                    }
                } else if ($scope.itensExigencia.txtExigenciaNaoCumprida == "Não entregue") {
                    conclusaoExigencia += " Houve a comunicação eletrônica e o envio da correspondência de exigências ao endereço do(a) Requerente constante no CNIS e/ou declinado no Requerimento, mas houve falha na entrega. Cabe ao(à) Requerente manter o seu endereço atualizado, nos termos do §1º, art. 548 da IN 128/2022, e art. 20 da Portaria Dirben/INSS nº 993/2022 (Livro IV - Processo Administrativo Previdenciário).";
                } else if ($scope.itensExigencia.txtExigenciaNaoCumprida == "Encerramento") {
                    conclusaoExigencia += " Passados mais de 75 dias da sua comunicação, não houve a apresentação de documentos que permitissem o reconhecimento do direito, sendo o pedido encerrado sem análise do mérito, nos termos do § único, art. 600 da Instrução Normativa nº 128/2022, e §3º, art. 105 da Portaria Dirben/INSS nº 993/2022 (Livro IV - Processo Administrativo Previdenciário).";
                } else if ($scope.itensExigencia.txtExigenciaNaoCumprida == "Não suficiente") {
                    conclusaoExigencia += " Houve a apresentação de documentos, porém verifica-se que não atendem ao exigido para a correta verificação do direito pleiteado, sendo o requerimento encerrado, nos termos do §4º, art. 566 da Instrução Normativa nº 128/2022.";
                } else if ($scope.itensExigencia.txtExigenciaNaoCumprida == "Não possui") {
                    conclusaoExigencia += " Houve a apresentação de declaração formal do(a) Requerente informando não possuir a documentação exigida, cabendo a imediata decisão do requerimento e verificação do direito pleiteado na forma como se encontra, nos termos do §3º, art. 566 da Instrução Normativa nº 128/2022.";
                };
                break;
        };
    ...
    $scope.montarProcedimento = function () {
        let conclusaoProcedimento = "No presente requerimento, houve a verificação de procedimentos adicionais: ";
        let listaMotivos = [];
        ...
        if ($scope.itensProcedimento.chkAvaliacaoConjunta) {
            ...
            else if ($scope.itensProcedimento.txtAvaliacaoConjunta == "Não Realizada") {
                if ($scope.especieSelecionada.descricao == "Aposentadoria por Idade Urbana" || $scope.especieSelecionada.descricao == "Aposentadoria por Idade Rural") {
                    listaMotivos.push("o(a) Requerente não foi submetido(a) a Avaliação Conjunta Biopsicossocial - Social e Médico-Pericial, em razão de não contar com os requisitos mínimos de 15 anos de contribuição e 55 anos de idade, se mulher, ou 60 anos, se homem, até a Data de Entrada do Requerimento (DER), nos termos do §1º do art. 2º do Decreto nº 8.145/2013");
                }
                else if ($scope.especieSelecionada.descricao == "Aposentadoria por Tempo de Contribuição") {
                    listaMotivos.push("o(a) Requerente não foi submetido(a) a Avaliação Conjunta Biopsicossocial - Social e Médico-Pericial, em razão de não contar com o requisito mínimo de 20 anos de contribuição, se mulher, ou 25 anos, se homem, até a Data de Entrada do Requerimento (DER), nos termos do §1º do art. 2º do Decreto nº 8.145/2013");
                }
            };
        };
        ...
        if ($scope.itensProcedimento.chkJustAdministrativa) {
            switch ($scope.itensProcedimento.txtJustAdministrativa) {
                case 'Desnecessária':
                    ...
                    break;
                case 'Autorizada':
                    listaMotivos.push("houve o requerimento de Justificação Administrativa, que após análise de requisitos, teve o seu processamento autorizado, nos termos do art. 86 da Portaria Dirben/INSS nº 993/2022 (Livro IV - Processo Administrativo Previdenciário)");
                    break;
                case 'Não Autorizada':
                    listaMotivos.push("houve o requerimento de Justificação Administrativa, porém a mesma não foi autorizada, em razão de não cumprir com seus requisitos de formalização do pedido ou apresentação de início de prova material suficiente para formar convicção quanto ao pretendido, nos termos do art. 151 do Decreto nº 3.048/99, art. 568 da Instrução Normativa nº 128/2022, e art. 79 da Portaria Dirben/INSS nº 993/2022 (Livro IV - Processo Administrativo Previdenciário)");
                    break;
                case 'Realizada Eficaz':
                    listaMotivos.push("houve o processamento de Justificação Administrativa, que após análise conclusiva quanto à sua forma e mérito, foi considerada eficaz para a comprovação pretendida, nos termos dos arts. 93 e 94 da Portaria Dirben/INSS nº 993/2022 (Livro IV - Processo Administrativo Previdenciário)");
                    break;
                case 'Realizada Ineficaz':
                    listaMotivos.push("houve o processamento de Justificação Administrativa, que após análise conclusiva quanto à sua forma e mérito, foi considerada ineficaz para a comprovação pretendida, nos termos dos arts. 93 e 94 da Portaria Dirben/INSS nº 993/2022 (Livro IV - Processo Administrativo Previdenciário)");
                    break;
            };
    ...
    $scope.montarOutro = function () {
        ...
        if ($scope.itensOutro.chkProcessoAnterior) {
            listaMotivos.push("houve o aproveitamento dos documentos e informações constantes no(s) processo(s) anterior(es) de nº " + $scope.itensOutro.txtProcessoAnterior + ", em observância ao disposto nos §§4º e 5º do art. 60 da Portaria Dirben/INSS nº 993/2022 (Livro IV - Processo Administrativo Previdenciário)");
        };
        ...
        if ($scope.itensOutro.chkQualidadeDesemprego) {
            listaMotivos.push("houve o acréscimo de 12 meses ao prazo de manutenção da qualidade de segurado, em razão da condição de desempregado(a) comprovada por registro em órgão próprio, nos termos do §2º, art. 13 do Decreto nº 3.048/99, e §5º, art. 184 da IN nº 128/2022");
        };
        if ($scope.itensOutro.chkQualidadeNaoDesemprego) {
            listaMotivos.push("não houve o acréscimo de 12 meses ao prazo de manutenção da qualidade de segurado, em razão de não ter sido comprovada a condição de desempregado(a) por registro em órgão próprio, ou do mesmo ter sido realizado fora do prazo de manutenção da qualidade de segurado relativo ao último vínculo, como disposto no §2º, art. 13 do Decreto nº 3.048/99, e §5º, art. 184 da IN nº 128/2022");
        };
        if ($scope.itensOutro.chkQualidade120Contribuicoes) {
            listaMotivos.push("houve o acréscimo de 12 meses ao prazo de manutenção da qualidade de segurado, em razão de ter somado mais de 120 contribuições mensais sem perda da qualidade de segurado, nos termos do §1º, art. 13 do Decreto nº 3.048/99, e  §4º, art. 184 da IN 128/2022");
        };
        if ($scope.itensOutro.chkQualidadeNao120Contribuicoes) {
            listaMotivos.push("não houve o acréscimo de 12 meses ao prazo de manutenção da qualidade de segurado, em razão de não ter somado mais de 120 contribuições mensais sem perda da qualidade de segurado, nos termos do §1º, art. 13 do Decreto nº 3.048/99, e §4º, art. 184 da IN 128/2022");
        };
        ...
        if ($scope.especieSelecionada.codigo == '42' && $scope.itensOutro.chkProporcional) {
            listaMotivos.push("o(a) Requerente concordou com a concessão da Aposentadoria na sua forma Proporcional, nos termos do §2º, art. 319 da IN nº 128/2022");
        };
        if ($scope.especieSelecionada.codigo == '42' && $scope.itensOutro.chkNaoProporcional) {
            listaMotivos.push("o(a) Requerente não concordou com a concessão da Aposentadoria na sua forma Proporcional, nos termos do §2º, art. 319 da IN nº 128/2022");
        };
        ...
        if ($scope.itensOutro.chkCessacaoBeneficio) {
            if ($scope.especieSelecionada.codigo == 'CTC') {
                listaMotivos.push("houve a cessação de benefício de Auxílio-Acidente, Auxílio-Suplementar ou Abono de Permanência em Serviço, de E/NB " + $scope.itensOutro.txtBeneficioCessado + ", em razão da emissão da Certidão de Tempo de Contribuição, nos termos do §5º, art. 511 da IN nº 128/2022, e art. 129 do Decreto nº 3.048/99");
            } else {
                listaMotivos.push("houve a cessação de benefício cuja acumulação é vedada, de E/NB " + $scope.itensOutro.txtBeneficioCessado + ", nos termos do art. 639 da IN nº 128/2022, e art. 167 do Decreto nº 3.048/99");
            };
        };
        ...
        if (($scope.especieSelecionada.codigo == '21' || $scope.especieSelecionada.codigo == '93') && $scope.itensOutro.chkSolicitarResiduo) {
            if ($scope.itensOutro.txtPeriodoResiduo != '') {
                listaMotivos.push("verificou-se a existência de valor não recebido até a data do óbito do(a) Instituidor(a), referente ao período de " + $scope.itensOutro.txtPeriodoResiduo + ", devendo o(a) Requerente solicitá-lo por meio do serviço \"Pagamento de Valor não Recebido até a Data do Óbito do Beneficiário\", através do Meu INSS ou pelo telefone 135");
            } else {
                listaMotivos.push("verificou-se a existência de valor não recebido até a data do óbito do(a) Instituidor(a), devendo o(a) Requerente solicitá-lo por meio do serviço \"Pagamento de Valor não Recebido até a Data do Óbito do Beneficiário\", através do Meu INSS ou pelo telefone 135");
            }
        };
        ...
        if ($scope.tipoDespacho == 'Indeferimento' && $scope.itensOutro.chkOpcaoRecurso) {
            listaMotivos.push("conclui-se pela possibilidade de interposição de Recurso pelo(a) Requerente, caso não concorde com a sua conclusão e em até 30 dias após sua ciência, através do serviço correspondente no Meu INSS ou pelo telefone 135");
        };
    ...
    $scope.despachoPensUrbInd = function () {
        ...
        if ($scope.itensMotivoDespacho.chkComprDepend && $scope.itensMotivoDespacho.chkDependNaoComprConjuge && $scope.itensMotivoDespacho.chkComprRestabUniao) {
            listaMotivos.push("do(a) Requerente não comprovar o restabelecimento do vínculo conjugal, posterior à declaração de separação de fato registrada em requerimento anterior, nos termos do art. 374 da Instrução Normativa nº 128/2022, e art. 504 da Portaria Dirben/INSS nº 991/2022 (Livro II - Benefício)");
        };
        ...
        if ($scope.itensMotivoDespacho.chkAposPrazo) {
            listaMotivos.push("do requerimento ter sido realizado após o prazo de duração de quatro meses, considerando o casamento/união estável ter iniciado a menos de dois anos antes do óbito do Instituidor, ou do óbito ter ocorrido sem que o Instituidor tenha vertido ao menos dezoito contribuições mensais, nos termos da alínea \"b\", inciso V, art. 114 do Decreto nº 3.048/99");
        };
    ...
    $scope.despachoPensRurInd = function () {
        ...
        if (!$scope.itensMotivoDespacho.chkQualSeg && !$scope.itensMotivoDespacho.chkNaoFiliadoRGPS && !$scope.itensMotivoDespacho.chkComprRural) {
            motivosIndeferimento += " A Qualidade de Segurado do(a) Instituidor(a) ficou estabelecida, ";
            if ($scope.itensMotivoDespacho.txtTipoInstituidor == "Em Atividade") {
                motivosIndeferimento += "em virtude de se encontrar em atividade ou em período de manutenção dessa condição na data do óbito.";
            }
    ...
    $scope.despachoAuxDoeUrbInd = function () {
        ...
        if ($scope.itensMotivoDespacho.chkNaoComparecimentoPericia) {
            listaMotivos.push("do(a) Requerente não ter comparecido à avaliação da Perícia Médica no local/data/hora agendados, procedimento indispensável para reconhecimento da incapacidade para o trabalho, nos termos do art. 71 do Decreto nº 3.048/99");
        };
        ...
        if ($scope.itensMotivoDespacho.chkFaltaTempo || $scope.itensMotivoDespacho.chkNaoNovasRegrasEC103) {
            ...
            if ($scope.itensMotivoDespacho.txtTempoMesesAnteriorEC103 != "") {
                if ($scope.itensMotivoDespacho.txtTempoAnosAnteriorEC103 != "" && $scope.itensMotivoDespacho.txtTempoDiasAnteriorEC103 == "") {
                    tempoTotalAnteriorEC += "e ";
                };
                tempoTotalAnteriorEC += $scope.itensMotivoDespacho.txtTempoMesesAnteriorEC103 + " meses ";
            };
            if ($scope.itensMotivoDespacho.txtTempoDiasAnteriorEC103 != "") {
                if ($scope.itensMotivoDespacho.txtTempoAnosAnteriorEC103 != "" || $scope.itensMotivoDespacho.txtTempoMesesAnteriorEC103 != "") {
                    tempoTotalAnteriorEC += "e ";
                };
                tempoTotalAnteriorEC += $scope.itensMotivoDespacho.txtTempoDiasAnteriorEC103 + " dias";
            };
        };
   ...
   $scope.despachoApTempLC142Ind = function () {
    ...
    $scope.despachoApEspInd =  function () {
        ...
        if ($scope.itensMotivoDespacho.chkFaltaTempo || $scope.itensMotivoDespacho.chkNaoNovasRegrasEC103) {
            ...
            if ($scope.itensMotivoDespacho.txtTempoDiasAnteriorEC103 != "") {
                tempoTotalAnteriorEC += " e " + $scope.itensMotivoDespacho.txtTempoDiasAnteriorEC103 + " dias";
            };
        };
    ...
    $scope.despachoSalMatUrbInd = function () {
        ...
        if ($scope.itensMotivoDespacho.chkPrescricao5Anos) {
            listaMotivos.push("da prescrição do direito ao benefício, considerando a realização do requerimento após o prazo de 5 (cinco) anos a contar da data do fato gerador, nos termos do §1º, art. 347 do Decreto nº 3.048/99, e §5º, art. 357 da Instrução Normativa nº 128/2022");
        };
    ...
    $scope.despachoAssDefInd = function () {
        ...
        if ($scope.itensMotivoDespacho.chkObitoRequerente) {
            ...
            $scope.itensMotivoDespacho.chkAmpliacaoRenda = false;
        ...
        if ($scope.itensMotivoDespacho.chkRendaSuperior) {
            if ($scope.itensMotivoDespacho.chkAmpliacaoRenda) {
                listaMotivos.push("da Renda per Capita do Grupo Familiar ser superior a 1/4 do Salário Mínimo, apurada em R$ " + $scope.itensMotivoDespacho.txtRenda + ", nos termos do §3º, art. 20 da Lei nº 8.742/93. Não houve a comprovação da condição de miserabilidade e situação de vulnerabilidade que permitissem ampliar o critério de aferição da renda familiar mensal, nos termos do art. 20-B da Lei nº 8.742/93");
            } else {
    ...
    $scope.despachoCTCInd = function () {
        ...
        if ($scope.itensMotivoDespacho.chkNaoApresentacaoDadosBasicos) {
            listaMotivos.push("da não informação de dados básicos necessários para sua emissão, nos termos do art. 544 da Portaria Dirben/INSS nº 991/2022 (Livro II - Benefício)");
        };
        if ($scope.itensMotivoDespacho.chkNaoComprRPPS) {
            listaMotivos.push("da não comprovação de vinculação do(a) Requerente a Regime Próprio de Previdência - RPPS, nos termos do art. 2º da Portaria MTP nº 1.467/2022, e art. 542 da Portaria Dirben/INSS nº 991/2022 (Livro II - Benefício)");
        };
        if ($scope.itensMotivoDespacho.chkPeriodosJaUtilizados) {
            listaMotivos.push("da impossibilidade de certificação de períodos de vinculação ao Regime Geral da Previdência Social - RGPS, considerando já terem sido aproveitados na concessão de Aposentadoria, nos termos do inc. II, art. 195 da Portaria MTP nº 1.467/2022, e art. 550 da Portaria Dirben/INSS nº 991/2022 (Livro II - Benefício)");
        };
        if ($scope.itensMotivoDespacho.chkJaPossuiCTC) {
            let textoJaPossuiCTC = "da existência de Certidão de Tempo de Contribuição já concedida, de nº " + $scope.itensMotivoDespacho.txtCTCAnterior + ", tratando-se de documento único e para o qual não foi solicitada revisão, nos termos do §1º, art. 511 da Instrução Normativa nº 128/2022, e art. 199 da Portaria MTP nº 1.467/2022"
        ...
        if ($scope.itensMotivoDespacho.chkNaoCessacaoAuxilio) {
            ...
            textoNaoCessacaoAuxilio += ", nos termos do §5º do art. 511 da Instrução Normativa nº 128/2022, e art. 129 do Decreto nº 3.048/99";
    ...
    $scope.despachoPensUrbConc = function () {
        ...
        if ($scope.itensMotivoDespacho.chkMotivoConc2) {
            ...
            if (($scope.itensMotivoDespacho.chkDependComprCompanheiro || $scope.itensMotivoDespacho.chkDependComprConjuge) && $scope.itensMotivoDespacho.chkCotaQuatroMeses) {
                conclusaoDependentes += ", salientando-se a extinção da cota do(a) Companheiro(a)/Cônjuge em quatro meses, em observância à alínea \"b\", inciso V, art. 114 do Decreto nº 3.048/99";
            }
    ...
    $scope.despachoAuxDoeUrbConc = function () {
        ...
        if ($scope.itensMotivoDespacho.chkMotivoConc3) {
            switch ($scope.itensMotivoDespacho.txtTipoAvaliacaoIncapacidade) {
                case 'Perícia':
                    listaMotivos.push("ter reconhecida a incapacidade para o trabalho em avaliação da Perícia Médica");
                    break;
                case 'Atestmed':
                    listaMotivos.push("ter reconhecida a conformação do atestado médico, realizada em análise documental (Atestmed)");
                    break;
            };
        };
    ...
    $scope.despachoApTempConc = function (){
        ...
        motivosConcessao += ", com o total de " + tempoTotal + "de Contribuição até a Data de Entrada do Requerimento.";
    ...
    $scope.despachoApEspConc = function () {
        ...
        if ($scope.itensMotivoDespacho.txtTipoAposTempo == "Nova") {
            motivosConcessao += "a concessão na sua forma definida no inc. I, §1º, art. 19 da Emenda Constitucional nº 103/2019, com o total enquadrado de " + tempoTotal + " de efetiva exposição a agentes prejudiciais à saúde até a Data de Entrada do Requerimento (DER).";
        } else if ($scope.itensMotivoDespacho.txtTipoAposTempo == "Transição") {
            motivosConcessao += "a sua concessão através da regra de transição definida no art. 21 da Emenda Constitucional nº 103/2019, com o total enquadrado de " + tempoTotal + " de efetiva exposição a agentes prejudiciais à saúde até a Data de Entrada do Requerimento (DER).";
        } else if ($scope.itensMotivoDespacho.txtTipoAposTempo == "Antiga") {
            motivosConcessao += "a concessão na sua forma definida no art. 64 do Decreto nº 3.048/99, com o total de " + tempoTotal + " enquadrados por categoria profissional e/ou exposição a agentes prejudiciais à saúde até a Data de Entrada do Requerimento (DER).";
        };
    ...
    $scope.despachoAnalise = function () {
        ...
        if ($scope.itensMotivoDespacho.chkMotivoAn4) {
            listaMotivos.push(" da solicitação de cópia de processo anterior, nos termos dos §§4º e 5º do art. 60 da Portaria Dirben/INSS nº 993/2022 (Livro IV - Processo Administrativo Previdenciário)");
        };
    ...
    $scope.Reiniciar = function () {
        ...
        $scope.itensMotivoDespacho.txtTempoAnosAnteriorEC103 = "";
        $scope.itensMotivoDespacho.txtTempoMesesAnteriorEC103 = "";
        $scope.itensMotivoDespacho.txtTempoDiasAnteriorEC103 = "";
        ...
        $scope.itensMotivoDespacho.txtTipoAvaliacaoIncapacidade = "Perícia";
    ...
    $scope.copiaDespacho = function() {
          // Seleciona a div pelo ID
          var conteudoDiv = document.getElementById("visualizacao");
                
          // Cria uma div temporária para inserir o conteúdo formatado
          var tempDiv = document.createElement("div");
          tempDiv.innerHTML = conteudoDiv.innerHTML;

          // Adiciona a div temporária ao DOM
          document.body.appendChild(tempDiv);

          // Usando o Range para selecionar o conteúdo formatado sem as tags HTML
          ...
          // Limpa a seleção e remove a div temporária
          selection.removeAllRanges();
